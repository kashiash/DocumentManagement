...
using DocumentManagement.Blazor.Server.Services;
...
using DocumentManagement.WebApi.JWT;
using DocumentManagement.Module.BusinessObjects;

namespace DocumentManagement.Blazor.Server {
    public class Startup {
        ...
        public void ConfigureServices(IServiceCollection services) {
            ...
            services.AddXaf<DocumentManagementBlazorApplication>(Configuration);
            ...
            services.AddXafSecurity(options => {
                ...
                options.UserType = typeof(DocumentManagement.Module.BusinessObjects.ApplicationUser);
                // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                options.UserLoginInfoType = typeof(DocumentManagement.Module.BusinessObjects.ApplicationUserLoginInfo);
            ...
            services.AddXafWebApi(options => {
                ...
                options.BusinessObject<Subcategory>();
            ...
            services.AddSwaggerGen(c => {
                ...
                c.SwaggerDoc("v1", new OpenApiInfo {
                    Title = "DocumentManagement API",
                    Version = "v1",
                    Description = @"Use AddXafWebApi(options) in the DocumentManagement.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
                });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
            if(env.IsDevelopment()) {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "DocumentManagement WebApi v1");
                });
            }
            else {
