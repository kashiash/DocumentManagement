...
namespace DocumentManagement.Blazor.Server {
    public partial class DocumentManagementBlazorApplication : BlazorApplication {
        public DocumentManagementBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void DocumentManagementBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
